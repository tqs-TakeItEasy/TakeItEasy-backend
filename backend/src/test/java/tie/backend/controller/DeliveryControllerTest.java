...
class DeliveryControllerTest {
    ...
    void whenGetDeliveryById_thenReturnDelivery() throws Exception{
        ...
        when(deliveryService.getDeliveryById(delivery1.getId())).thenReturn(delivery1);
    ...
    void whenGetDeliveriesByPickupPointId_thenReturnDelivery() throws Exception{
        ...
        when(pickupPointService.getPickupPointById(delivery1.getPickupPoint().getId())).thenReturn(delivery1.getPickupPoint());
