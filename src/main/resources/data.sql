...
INSERT INTO delivery (userN, userE, packageI, pickup_point_id, store_id, status, registryD, deliveryD, pickupD) VALUES ('Anthony Conho', 'anthonytheconho@gmail.com', 1, 1, 1, 'DISPATCHED', '2023-05-29', 'TBD', 'TBD');
INSERT INTO delivery (userN, userE, packageI, pickup_point_id, store_id, status, registryD, deliveryD, pickupD) VALUES ('John Doe', 'johndoe@example.com', 2, 2, 1, 'DISPATCHED', '2023-05-30', 'TBD', 'TBD');
INSERT INTO delivery (userN, userE, packageI, pickup_point_id, store_id, status, registryD, deliveryD, pickupD) VALUES ('Jane Smith', 'janesmith@example.com', 3, 1, 1, 'RECIEVED', '2023-05-29', '2023-05-31', 'TBD');
